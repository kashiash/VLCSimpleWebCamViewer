...
namespace WinFormOpenCVRec2
{
    public partial class Form1 : Form
    {
        ...
        private VideoCapture captureRecord;
        ...
        private void StartRecording()
        {
            ...
            captureRecord = new OpenCvSharp.VideoCapture(); //VideoCapture.FromCamera(deviceIndex, _videoCaptureApi);
            captureRecord.Open(currentCamera, videoCaptureApi);

            captureRecord.FrameWidth = frameWidth;
            captureRecord.FrameHeight = frameHeight;
            captureRecord.Fps = 29;
            ...
            videoWriter = new VideoWriter(path, fourCC, captureRecord.Fps, new OpenCvSharp.Size(frameWidth, frameHeight));
